...
Scope: read-only inspection of `assets/CV/`, website references, the Excel links sheet, generated JSON, and extracted PDF/DOCX text. No CV file, download link, Excel workbook, JSON file, page, or script was modified.
...
| `assets/CV/Longlong_Li_CV_EN.docx` | DOCX | 40,702 B | 2026-05-25 15:53:30 | No active reference found | Archive candidate: older general English CV source |
| `assets/CV/Longlong_Li_CV_EN.pdf` | PDF, 3 pages | 7,507 B | 2026-05-25 15:53:30 | No active reference found | Archive candidate: older general English CV export |
| `assets/CV/Longlong_Li_CV_ZH.docx` | DOCX | 41,081 B | 2026-05-25 15:53:30 | No active reference found | Archive candidate: older general Chinese CV source |
| `assets/CV/Longlong_Li_CV_ZH.pdf` | PDF, 3 pages | 9,842 B | 2026-05-25 15:53:30 | No active reference found | Archive candidate: older general Chinese CV export |
...
## Unclear or unused CV files

The following four files have no confirmed reference in HTML, JavaScript, JSON, Excel, Python generators, README, or maintenance documentation:

- `assets/CV/Longlong_Li_CV_EN.docx`
- `assets/CV/Longlong_Li_CV_EN.pdf`
- `assets/CV/Longlong_Li_CV_ZH.docx`
- `assets/CV/Longlong_Li_CV_ZH.pdf`
...
Their modified time is four days earlier than the Academic CV and Resume set. The current `tools/generate_cv_docs.py` defines output targets only for `Longlong_Li_Academic_CV_*` and `Longlong_Li_Resume_*`; it does not regenerate `Longlong_Li_CV_*`. This supports classifying the four general CV files as an older superseded version, subject to manual confirmation.
...
| `assets/CV/Longlong_Li_CV_EN.docx` | Move to `archive/` after user confirmation | Older unreferenced general CV source with substantial overlap | Low after confirmation |
| `assets/CV/Longlong_Li_CV_EN.pdf` | Move to `archive/` with its DOCX after user confirmation | Older unreferenced export | Low after confirmation |
| `assets/CV/Longlong_Li_CV_ZH.docx` | Move to `archive/` after user confirmation | Older unreferenced general CV source with substantial overlap | Low after confirmation |
| `assets/CV/Longlong_Li_CV_ZH.pdf` | Move to `archive/` with its DOCX after user confirmation | Older unreferenced export | Low after confirmation |

Recommended sequence:

1. Keep all current download files in place.
2. Confirm that the older `Longlong_Li_CV_*` presentation is no longer needed.
3. Archive the four older files together, preserving English/Chinese and DOCX/PDF pairs.
...
Do not delete any file during this audit.
...
- the four unreferenced `Longlong_Li_CV_*` files until the user confirms that the older layout contains no presentation or wording worth preserving;
